...
interface FileListProps {
  ...
  onContextMenu: (name: string, event: ReactMouseEvent<HTMLTableRowElement>) => void;
}

export function FileList({ files, selected, onNavigate, onSelect, onContextMenu }: FileListProps) {
  return (
