...
export function Toolbar({ selectedCount, onImport, onExport, onDelete, canGoBack, onBack, canGoForward, onForward, canGoUp, onUp, onRefresh, onBookmark }: ToolbarProps) {
